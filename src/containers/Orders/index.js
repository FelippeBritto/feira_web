        ...
        return (
            <React.Fragment>
                ...
                <div className="Content">
                    <div className="Card">
                        <p className="CardText">Meus Pedidos</p>
                                ...
                                return (
                                    <div key={order._id} className="Order">
                                        ...
                                        <div className="OrderFooter">
                                            <p>Pedido feito em <span>{this.formatDate(order.orderDate)}</span></p>
                                            <p>Total do Pedido <span>${this.getOrderTotal(order._id)}</span></p>
                                        </div>
                                    </div>
                                )
                            })
