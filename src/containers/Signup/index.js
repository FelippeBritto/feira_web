...
class Signup extends Component {
    ...
    signupHandler = (e) => {
        ...
        if(signupForm.email === ''){
            this.setError(true, 'Campo Email Obrigatório!');
            return;
        }
        if(signupForm.password === ''){
            this.setError(true, 'Campo Senha Obrigatório!');
            return;
        }
        if(signupForm.repassword === ''){
            this.setError(true, 'Confirmar Senha Obrigatório!');
            return;
        }
        if(signupForm.password !== signupForm.repassword){
            this.setError(true, 'As senhas devem ser iguais!');
            return;
        }
